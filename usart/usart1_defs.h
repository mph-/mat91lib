...
#define USART1_READ_READY_P() ((USART1->US_CSR & AT91C_US_RXRDY) != 0)

#define USART1_WRITE_READY_P() ((USART1->US_CSR & AT91C_US_TXRDY) != 0)

#define USART1_WRITE_FINISHED_P() ((USART1->US_CSR & AT91C_US_TXEMPTY) != 0)
