...
#define USART0_READ_READY_P() ((USART0->US_CSR & AT91C_US_RXRDY) != 0)

#define USART0_WRITE_READY_P() ((USART0->US_CSR & AT91C_US_TXRDY) != 0)

#define USART0_WRITE_FINISHED_P() ((USART0->US_CSR & AT91C_US_TXEMPTY) != 0)
