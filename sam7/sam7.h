...
#define US_MR_USART_MODE_NORMAL AT91C_US_USART_MODE_NORMAL
#define US_MR_CLKS_CLOCK AT91C_US_CLKS_CLOCK
#define US_MR_CHRL_8_BITS AT91C_US_CHRL_8_BITS
#define US_MR_PAR_NONE AT91C_US_PAR_NONE
#define US_MR_NBSTOP_1_BIT AT91C_NBSTOP_1_BIT
